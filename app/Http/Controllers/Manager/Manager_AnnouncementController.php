...
class Manager_AnnouncementController extends Controller
{
    //
    public function index()
    {
        ...
        return view('manager.announcements.index')->with(['announcements' => $announcements]);
    }
    ...
    public function show(Announcement $announcement)
    {
        ...
        return view('manager.announcements.show', compact('announcement', 'comments'));
    }
    ...
    {
        return view('manager.announcements.confirm_delete', compact('announcement'));
    }
