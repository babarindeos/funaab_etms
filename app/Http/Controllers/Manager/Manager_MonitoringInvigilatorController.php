...
class Manager_MonitoringInvigilatorController extends Controller
{
    //
    public function select_exam_invigilator(Request $request)
    {
            ...
            return view('manager.monitoring_invigilators.select_exam_invigilators', compact('exams'))->with(['isPostBack'=>$isPostBack, 
    ...
    public function invigilations(Exam $exam, User $invigilator)
    {
         ...
         return view('manager.monitoring_invigilators.invigilations', compact('invigilations', 'exam', 'invigilator'));
