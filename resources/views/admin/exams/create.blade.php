<x-admin-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.exams.store')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf

                        

                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >New Exam</h2>
                            ...
                            <select name="semester" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Academic Semester --</option>
                                                                        @foreach($semesters as $semester)
                                                                            ...
                                                                            @endphp
                                                                            <option class='py-4' value="{{$semester->id}}">{{$semester_name}} ({{ ($semester->academic_session->name) }})</option>
                                                                        @endforeach                                                                    
                                                                    </select>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Create Exam</button>
                        </div>
