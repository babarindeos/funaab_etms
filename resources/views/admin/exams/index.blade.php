            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            <a href="{{ route('admin.exams.create') }}" class="bg-green-600 text-white py-2 px-4 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500"><i class="fas fa-plus text-xs"></i> New Exam</a>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <span class="text-sm">
                                                            <a class="hover:bg-purple-500 bg-purple-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs" href="{{ route('admin.exams.days.index', ['exam'=>$exam->id])}}">Exam Days</a>
                                                        </span>
