<x-admin-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.exams.exam_days.select_exam_days')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                ...
                @if ($isPostBack && $exam_selected)
                    ...
                    <form  action="{{ route('admin.exams.exam_days.load_exam_day_schedule')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
