    ...
    <div class="container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">TimTec Allocation</h1>
                    </div>  
                    <div>
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.exams.timtec_allocation.select_exam_day')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                ...
                @if ($isPostBack && $exam_selected)
                    ...
                    <form  action="{{ route('admin.exams.timtec_allocation.load_timtec_allocator')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
