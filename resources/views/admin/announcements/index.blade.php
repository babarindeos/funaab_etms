        ...
        <section class="flex flex-col w-full md:w-full py-8 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            ...
                            <a href="{{ route('admin.announcements.create') }}" class="border border-green-600 text-green-600 py-2 px-6 
                                ...
                                <td class="py-2 pr-4">
                                    ...
                                    <div>
                                        ...
                                        class='text-blue-500 underline font-semibold' >
                                            <a class="font-semibold text-blue-800 underline" href="{{ route('admin.announcements.show',['announcement'=>$announcement->id]) }}">
                                ...
                                <td>
                                            <span class="px-1">
                                                <a class="bg-green-400 hover:bg-green-500 text-white rounded-md px-4 py-1 text-xs"
                                                    href="{{ route('admin.announcements.notify', ['announcement'=> $announcement->id]) }}">
                                                    Notify
                                                </a>
                                            </span>
                                            <span class="text-sm">
                                                <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.announcements.edit', ['announcement' => $announcement->id]) }}">Edit</a>
                                            </span>
                                            <span> 
                                                <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.announcements.confirm_delete', ['announcement'=> $announcement->id])}}"
                                                >Delete</a>
                                            </span>	
