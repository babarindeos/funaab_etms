    ...
    <div class="flex flex-col border-0 w-[89%] md:w-[93%] mx-auto">
        <section class="flex flex-row justify-between border-b border-gray-200 py-2 mt-6">
                ...
                <div>
                            ...
                            <a href="{{ route('admin.announcements.index') }}" class="border border-green-600 text-green-600 py-2 px-6 
        ...
        <section class="py-8 mt-2">
                <div>
                    <form  action="{{ route('admin.announcements.update', ['announcement'=>$announcement->id]) }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
