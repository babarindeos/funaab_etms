    ...
    <div class="container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Monitoring: Chief Invigilators</h1>
                    </div>  
                    <div>
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.monitoring.chiefs.select_exam_chief')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                                    ...
                                    <table width='100%' class="table-auto border-collapse border border-1 border-gray-200" 
                                        ...
                                        <thead>
                                            <tr class="bg-gray-200">
                                                <th width='15%' class="text-center font-semibold py-2">SN</th>
                                                <th width='85%' class="font-semibold py-2 text-left">Chief Invigilator</th>                                                
                                        ...
                                        <tbody>
                                            @php
                                                $counter = 0;
                                            @endphp
                                            @foreach($exam_chiefs_allocations as $exam_chief)
                                            
                                                <tr>
                                                    <td class='text-center py-4'>{{ ++$counter }}.</td>
                                                    <td>
                                                        <a href="{{ route('admin.profile.user_profile', ['fileno' => $exam_chief->chief->staff->fileno]) }}" class="hover:underline">
                                                            {{ $exam_chief->chief->staff->staff_title->title}} 
                                                            {{ ucfirst(strtolower($exam_chief->chief->staff->surname)) }} 
                                                            {{ $exam_chief->chief->staff->firstname }}
                                                        </a>
                                                    </td>
                    ...
                    @endif
                    <!-- end of records of Chiefs in the selected exams //-->
