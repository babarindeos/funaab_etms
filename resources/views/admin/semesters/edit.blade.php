<x-admin-layout>
    <div class="flex flex-col w-full mx-auto">
        ...
        <section class="mb-8">
                <div>
                    <form  action="{{ route('admin.semesters.update', ['semester'=>$semester->id]) }} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf

                        

                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                                <h2 class="font-semibold text-xl py-1" >Edit Semester</h2>
                            ...
                            <select name="academic_session" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Academic Session --</option>
                                                                        @foreach($academic_sessions as $academic_session)
                                                                            <option class='py-4' @if ($academic_session->id==$semester->academic_session_id) selected @endif value="{{$academic_session->id}}">{{$academic_session->name}} @if ($academic_session->current) (Current) @endif </option>
                                                                        @endforeach                                                                    
                                                                    </select>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-2">
                            ...
                            <select name="semester" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Semester --</option>
                                                                        <option class='py-4' value="first" @if ($semester->name == 'first') selected @endif>First Semester</option>
                                                                        <option class='py-4' value="second" @if ($semester->name == 'second') selected @endif>Second Semester</option>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Update Semester</button>
                        </div>
