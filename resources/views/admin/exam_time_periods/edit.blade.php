<x-admin-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.exams.exam_time_periods.update',['exam_time_period'=>$exam_time_period->id])}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf

                        

                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >Edit Exam Time Period</h2>
                        ...
                        <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 border-red-900 w-[80%] md:w-[60%] py-3">
                            ...
                            <div class="flex flex-col md:w-1/2">
                                        <input type="time" name="start_time" class="border border-1 border-gray-400 bg-gray-50
                                                                                ...
                                                                                value="{{ $exam_time_period->start_time }}"
                            ...
                            <div class="flex flex-col md:w-1/2">
                                        <input type="time" name="end_time" class="border border-1 border-gray-400 bg-gray-50
                                                                                ...
                                                                                value="{{ $exam_time_period->end_time }}"
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Update Exam Time Period</button>
                        </div>
