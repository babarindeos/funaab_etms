    ...
    <div class="container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Create Venue</h1>
                    </div>  
                    <div>
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.venues.store')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf

                        

                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >New Venue</h2>
                            ...
                            <select name="venue_type" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    <option value=''>-- Select Venue Type --</option>
                                                                        ...
                                                                        @foreach($venue_types as $venue_type)                                                                                                                            
                                                                                 ...
                                                                                 <option class='py-4' value="{{$venue_type->id}}">{{ $venue_type->name }} </option>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Create Venue</button>
                        </div>
