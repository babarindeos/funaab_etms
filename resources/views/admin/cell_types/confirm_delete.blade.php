<x-admin-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.cell_types.destroy', ['cell_type' => $cell_type->id]) }} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf
                        ...
                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            ...
                            Do you really wish to delete this Cell Type?
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-red-400 py-4 px-4 text-white 
                                           hover:bg-red-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Delete Cell Type</button>
                        </div>
