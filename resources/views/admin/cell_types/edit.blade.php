    ...
    <div class=" border-0 border-blue-900 container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Cell Type</h1>
                    </div>       
                    <div>
        ...
        <section class="mb-8">
                <div>
                    <form  action="{{ route('admin.cell_types.update', ['cell_type' => $cell_type->id])}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf
