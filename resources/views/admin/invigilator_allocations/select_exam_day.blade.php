    ...
    <div class="container mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Invigilator Allocation</h1>
                    </div>  
                    <div>
                            <a href="{{ route('admin.exams.index') }}" class="bg-green-600 text-white py-2 px-4 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500"> Invigilations</a>
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.exams.invigilator_allocation.select_exam_day')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                ...
                @if ($isPostBack && $exam_selected)
                    ...
                    <form  action="{{ route('admin.exams.invigilator_allocation.load_invigilator_allocator')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
