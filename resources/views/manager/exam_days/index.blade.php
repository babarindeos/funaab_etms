    ...
    <div class="flex flex-col w-full border-0 border-blue-900 mx-auto mb-8">
        ...
        <section class="flex flex-col w-[95%] md:w-[95%] py-2 mt-6 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            <a href="{" class="border-green-600 border text-green-600 py-2 px-4 
                                                    ...
                                                    <td class="text-center">
                                                        <span class="text-sm px-1">
                                                            <a class="hover:bg-purple-500 bg-purple-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs" href="{{ route('manager.exams.exam_scheduler.scheduler',['exam_day'=>$exam_day->id]) }}">
                                                                    Schedule
                                                            </a>
                                                        </span>
                                                        <span class="text-sm">
                                                            <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs hidden" href="{{ route('admin.exams.days.edit', ['exam'=>$exam->id,'day'=>$exam_day->id]) }}">Edit</a>
                                                        </span>
                                                        <span> 
                                                            <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs hidden" href="{{ route('admin.exams.days.confirm_delete', ['exam'=>$exam->id,'day'=>$exam_day->id]) }}"
                                                            >Delete</a>
                                                        </span>
                                                    </td>
