<x-manager-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('manager.exams.exam_days.select_exam_days')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                ...
                @if ($isPostBack && $exam_selected)
                    ...
                    <form  action="{{ route('manager.exams.exam_days.load_exam_day_schedule')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Exam Day Schedule</button>
                        </div>
