<x-manager-layout>
    ...
    <div class="flex flex-col border-0 w-[89%] md:w-[93%] mx-auto">
        ...
        <section class="py-8 mt-2">
                <div>
                    <form  action="{{ route('manager.announcements.store') }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
