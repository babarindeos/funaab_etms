    ...
    <div class="flex flex-col w-full border-0 border-blue-900 mx-auto">
        ...
        <section class="flex flex-col w-[95%] md:w-[95%] py-2 mt-6 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            <a href="{{ route('admin.exams.create') }}" class="bg-green-600 text-white py-2 px-4 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500 hidden"><i class="fas fa-plus text-xs"></i> New Exam</a>
                                    ...
                                    <table class="table-auto border-collapse border border-1 border-gray-200" 
                                        ...
                                        <thead>
                                            <tr class="bg-gray-200">
                                                ...
                                                <th width='15%' class="font-semibold py-2 text-left">Start Date</th>   
                                                <th width='15%' class="font-semibold py-2 text-left">End Date</th>                                   
                                                <th width='30%' class="font-semibold py-2 text-center">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @php
                                                $counter = ($exams->currentPage() -1 ) * $exams->perPage();
                                            @endphp
                                                ...
                                                <tr class="border border-b border-gray-200">
                                                    ...
                                                    <td>        
                                                        @php 
                                                          $semester = ucfirst($exam->semester->name);
                                                        @endphp
                                                         {{ $semester }}                                             
                                                    </td>
                                                    <td>
                                                            <a href="{{ route('manager.exams.days.index', ['exam'=>$exam->id])}}" class="hover:underline">                                
                                                                {{ $exam->name }}                                                                
                                                            </a>   
                                                    </td>
                                                    <td>
                                                            {{ \Carbon\Carbon::parse($exam->start_date)->format('D. jS M., Y') }}
                                                    </td>
                                                    <td>
                                                            {{ \Carbon\Carbon::parse($exam->end_date)->format('D. jS M., Y') }}
                                                    </td>                                                    
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <span class="text-sm">
                                                            <a class="hover:bg-purple-500 bg-purple-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs" href="{{ route('manager.exams.days.index', ['exam'=>$exam->id])}}">Exam Days</a>
                                                        </span>

                                                        <span class="text-sm hidden">
                                                            <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs" href="{{ route('admin.exams.edit', ['exam'=>$exam->id])}}">Edit</a>
                                                        </span>

                                                        <span class="text-sm hidden">
                                                            <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                                    px-4 py-1 text-xs" href="{{ route('admin.exams.confirm_delete', ['exam'=>$exam->id])}}">Delete</a>
                                                        </span>
