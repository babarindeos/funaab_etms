<x-manager-layout>
    <div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('manager.monitoring.timtecs.select_exam_timtec')}} " method="GET" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf                        
                                    ...
                                    <table width='100%' class="table-auto border-collapse border border-1 border-gray-200" 
                                        ...
                                        <thead>
                                            <tr class="bg-gray-200">
                                                ...
                                                <th width='85%' class="font-semibold py-2 text-left">Timtec Supervisor</th>                                                
                    ...
                    @endif
                    <!-- end of records of Timtec in the selected exams //-->
