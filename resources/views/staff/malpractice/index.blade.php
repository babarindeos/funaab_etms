                ...
                <table class="table-auto border-collapse border border-1 border-gray-200" 
                    ...
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="font-semibold py-2 text-left">Student</th>
                    ...
                    <tbody>
                        @php
                            $counter = ($misconducts->currentPage() - 1) * $misconducts->perPage();
                        @endphp
                        @foreach($misconducts as $report)
                            <tr class="border border-b border-gray-200 ">
                                <td width='6%' class='text-center py-4'>{{ ++$counter }}.</td>
                                <td class="py-8 pr-4">
                                    
                                    {{ $report->student_name}} ({{ $report->matric_no }})
        ...
        @else
            <section class="flex flex-col w-[95%] md:w-[95%] mx-auto px-4">
                <div class="flex flex-row border-0 justify-center 
                        ...
                        There is currently no Misconduct Incidence
                </div>
            </section>
        @endif
