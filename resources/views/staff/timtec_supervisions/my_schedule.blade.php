    ...
    @if ($exam->semester->current)
                ...
                <section class="flex flex-col md:flex-row py-1 mt-4 justify-between" >
                    <div class="flex flex-col md:w-1/2 border border-0">
                            ...
                            <div class='text-md'>
                                My Schedules ( {{ $my_supervisions->count() }} )
                            </div>
                    </div>
                ...
                <!-- Schedule //-->
                        ...
                        @foreach($my_supervisions as $supervision)
                                    ...
                                    <tr class='border-0'>
                                        ...
                                        <td>
                                            <div class='flex flex-col'>
                                                <div class='text-2xl'>
                                                    {{ $supervision->exam_day->name }}
                                                </div>
                                                <div class='text-xl font-semibold'>
                                                    {{ \Carbon\Carbon::parse($supervision->exam_day->date)->format('l jS F, Y') }}
                                                </div>
                                            </div>
                                                    ...
                                                    <tr class='border-b'>
                                                            <td width="60%" class='py-2'>
                                                                    <div class='border-0 flex flex-col md:flex-row'>
                                                                            <div class='text-lg pr-2 border-0 flex-2'>
                                                                                {{ $supervision->venue_category_group->name }} 
                                                            ...
                                                            <td width="40%" class="border-0 flex flex-col w-full py-2">
                                                                    <div class='flex flex-col md:flex-row md:items-center md:space-x-1 md:justify-start border-0'>
                                                                            <div class='text-lg'>
                                                                                {{ $supervision->time_period->name }} 
                                                                            </div>
                                                                            <div>
                                                                                ({{ \Carbon\Carbon::parse( $supervision->time_period->start_time)->format('g:i a') }} - 
                                                                                {{ \Carbon\Carbon::parse( $supervision->time_period->end_time)->format('g:i a') }})
                                                                            </div>
                                                                    </div>                                                                    
                                                            </td>
                                                     ...
                                                     <tr>
                                                         <td class='py-2 pb-8'colspan="2">
                                                                    <div class='space-x-4 text-center'>
                                                                         ...
                                                                         <a href="{{ route('staff.exams.timtec_supervisions.attendance', ['supervision'=>$supervision->id]) }}" class='border rounded-md 
                                                                                        px-4 py-1 text-sm border-green-400 
                                                                                        hover:bg-green-400 hover:text-white'>Invigilators Attendance</a>
